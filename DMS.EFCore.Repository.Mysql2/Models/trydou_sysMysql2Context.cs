...
{
    public partial class trydou_sysMysql2Context : DbContext
    {
        public trydou_sysMysql2Context()
        {
        }

        public trydou_sysMysql2Context(DbContextOptions<trydou_sysMysql2Context> options)
            : base(options)
        {
        }
