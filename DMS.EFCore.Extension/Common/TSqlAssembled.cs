...
namespace DMS.EFCore.Extension.Common
{
    ...
    public static class TSqlAssembled
    {
        ...
        /// <returns></returns>
        public static TSqlAssembledResult Update<TEntity>(Expression<Func<TEntity, bool>> fields, Expression<Func<TEntity, bool>> predicate) where TEntity : class
        {
            try
            {
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public static TSqlAssembledResult Update<TEntity>(TEntity entity, Expression<Func<TEntity, bool>> predicate) where TEntity : class
        {
            try
            {
                StringBuilder strBuilder = new StringBuilder();
        ...
        /// <param name="predicate"></param>
        /// <returns></returns>
        public static TSqlAssembledResult Delete<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : class
        {
            try
            {
